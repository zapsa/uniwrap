...
wrapper.call('getUser').then((data) => {
    console.log(data);
}).catch((error) => {
    console.log(error)
});
...
wrapper.call('getUser').then((data) => {
    document.getElementById('result').innerHTML = JSON.stringify(data[0]);
    console.log(data);
}).catch((error) => {
    console.log(error)
});
...
wrapper.call('login', {
    team: 'a',
    body: JSON.stringify({email: 'julien@zap.lu', hash: 'lol'})
}).then((data) => {
    console.log(data);
}).catch((error) => {
    console.log(error)
